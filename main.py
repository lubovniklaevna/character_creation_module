...
def attack(char_name: str, char_class: str) -> str:
    """Описывать работу функции attack тут."""
...
def defence(char_name: str, char_class: str) -> str:
    """Описывать работу функции efence тут."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Описывать работу функции special тут."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Описывать работу функции start_training тут."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Описывать работу функции choice_char_class тут."""
    approve_choice: str = ''
    char_class: str = ''
...
def main():
    """Описывать работу функции main тут."""
